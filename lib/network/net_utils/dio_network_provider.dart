...
import 'package:norrenberger_assesment/network/net_utils/interceptors.dart';
import 'package:pretty_dio_logger/pretty_dio_logger.dart';
import 'package:norrenberger_assesment/network/exceptions/data_transformer.dart';
import 'package:norrenberger_assesment/network/exceptions/error_code.dart';
import 'package:norrenberger_assesment/network/exceptions/ground_exception.dart';
import 'package:norrenberger_assesment/network/exceptions/response_exceptions.dart';
...
class AppNetworkProvider {
  ...
  Future<Either<ApiException, Response?>> call({
  ...
  Future<Either<ApiException, Response?>> download({
    required String path,
